...
func.func @test_toy_addptr_tensor(%arg0: tensor<2x!toy.ptr<i32>>, %arg1: i32) -> (tensor<2x!toy.ptr<i32>>) {
  %1 = toy.addptr %arg0, %arg1 : tensor<2x!toy.ptr<i32>>, i32 -> tensor<2x!toy.ptr<i32>>
